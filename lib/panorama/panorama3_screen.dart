...
class Panorama3Screen extends StatefulWidget {
  const Panorama3Screen({super.key});

  @override
  State<Panorama3Screen> createState() => _Panorama3ScreenState();
}

class _Panorama3ScreenState extends State<Panorama3Screen> {
        ...
        children: [
          !_isVideoReady
              ...
              : PanoramaViewer(
                ...
                hotspots: [
                  _buildHotspot(117, -20, 0, Icons.info, Colors.blue),
                  _buildHotspot(-50, -20, 3, Icons.info, Colors.blue),
                  _buildHotspot(196, -25, 1, Icons.info, Colors.blue),
                  _buildHotspot(8, -22, 2, Icons.info, Colors.blue),
                ],
