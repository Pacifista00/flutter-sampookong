...
class Panorama1Screen extends StatefulWidget {
  const Panorama1Screen({super.key});

  @override
  State<Panorama1Screen> createState() => _Panorama1ScreenState();
}

class _Panorama1ScreenState extends State<Panorama1Screen> {
        ...
        children: [
          !_isVideoReady
              ...
              : PanoramaViewer(
                ...
                hotspots: [
                  _buildHotspot(-139, -20, 0, Icons.info, Colors.blue),
                  _buildHotspot(43, -20, 3, Icons.info, Colors.blue),
                  _buildHotspot(-1, -25, 1, Icons.info, Colors.blue),
                  _buildHotspot(133, -22, 4, Icons.info, Colors.blue),
                  _buildHotspot(93, -22, 2, Icons.info, Colors.blue),
                ],
